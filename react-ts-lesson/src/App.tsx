...
import { CounterProvider, initState } from "./components/CounterContex";
import UseReducerCounterCopy from "./components/UseReducerCountercopy";
...
function App() {
  ...
  const addtwo = useCallback((_e: MouseEvent<HTMLButtonElement> | KeyboardEvent<HTMLButtonElement>) :void => setcallbackCount(prev => prev+2), [])
...
// +++++++++++++++++++++++++++++   use memo ++++++++++++++++++++++++++++++
  ...
  return (
    <>
      ...
      <br></br>
      <br></br>
      <p>Fetching using UseContext </p>
      
      <CounterProvider count={initState.count} text={initState.text}>
        <UseReducerCounterCopy></UseReducerCounterCopy>
      </CounterProvider>
